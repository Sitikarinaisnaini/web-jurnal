            ...
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                        ...
                        <a href="{{ route('mapel.index') }}" class="btn btn-md btn-info mb-3">Mapel</a>
                        <a href="{{ route('guru.index') }}" class="btn btn-md btn-info mb-3">Guru</a>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('pengajar.destroy', $pengajar->id) }}" method="POST"> 
                                        ...
                                        <a href="{{ route('pengajar.edit', $pengajar->id) }}" class="btn btn-sm btn-primary mr-2">EDIT</a>
                                        @csrf
                                        @method('DELETE')
